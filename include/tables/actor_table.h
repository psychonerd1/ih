...
DEFINE_ACTOR(En_Kadus, ACTOR_EN_KADUS, ACTOROVL_ALLOC_NORMAL, "Obj_Kadus")
DEFINE_ACTOR(En_Aza, ACTOR_EN_AZA, ACTOROVL_ALLOC_NORMAL, "Obj_Aza")
DEFINE_ACTOR(En_Lir, ACTOR_EN_LIR, ACTOROVL_ALLOC_NORMAL, "Obj_Lir")
DEFINE_ACTOR(En_Nir, ACTOR_EN_NIR, ACTOROVL_ALLOC_NORMAL, "Obj_Nir")
DEFINE_ACTOR(En_Met1, ACTOR_EN_MET1, ACTOROVL_ALLOC_NORMAL, "Obj_Met1")
DEFINE_ACTOR(En_Met2, ACTOR_EN_MET2, ACTOROVL_ALLOC_NORMAL, "Obj_Met2")
